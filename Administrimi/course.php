...
Video link: <input type="text" name="text">
<input type="hidden" name="id" value="<?php echo $_GET['ID'];?>">

<input type="submit" name="submit4" value="submit">
</form>
<h1>Edit or delete:</h1>
<a href="search1.php?ID=4">
<input type="submit" name="edit" value="Edit or Delete">
</a>
				<div class="blog-comments">
				<h1>Edit or delete Comments:</h1>
<a href="search1.php?ID=5">
<input type="submit" name="edit" value="Edit or Delete Comments">
</a>
							<h3>Comments</h3>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<p><?php echo "$Text"?></p>
									<div class="date-reply"><span><?php echo "$date"?></span><a href="#" class="reply">Reply</a></div>
								</div>
<?php } ?>
								</div>
