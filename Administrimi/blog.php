...
Teacher: <input type="text" name="text">
Category: <input type="text" name="text2">
<input type="submit" name="submit3" value="submit">
</form>
<h1>Edit or delete:</h1>
<a href="search1.php?ID=2">
<input type="submit" name="edit" value="Edit or Delete">
					...
					<div id="aside" class="col-md-3">
						...
						<div class="widget category-widget">
							<h3>Categories</h3>
							<a class="category" href="blog.php?ID=2">Web <span>12</span></a>
							<a class="category" href="blog.php?ID=3">Programming <span>5</span></a>
							<a class="category" href="blog.php?ID=4">SQL <span>24</span></a>
